...
save_path = os.path.join(save_dir, f'fnn_window_{window_size}_1.pth')
print(save_path)
...
def evaluate_model(model, test_loader, scaler, device='cuda'):
    ...
    save_path = os.path.join(save_dir, f'array/fnn_window_{window_size}_preds_targets_1.npy')
    ...
    save_path = os.path.join(save_dir, f'array/fnn_window_{window_size}_results_1.npy')
