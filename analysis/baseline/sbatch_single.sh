...
#     CUDA_VISIBLE_DEVICES=$GPU_ID python -u single_lstm_train.py \
#         --window_size $WINDOW_SIZE &> single_branch/logs/lstm_w${WINDOW_SIZE}.log &
# done
# wait
...
#         --window_size $WINDOW_SIZE &> single_branch/logs/fnn_w${WINDOW_SIZE}.log &
# done
# wait
